...
function se() {
  var e = {};
  function r(n, a) {
    g(e[a]) && g(n) ? e[a] = se(e[a], n) : g(n) ? e[a] = se({}, n) : le(n) ? e[a] = n.slice() : e[a] = n;
  }
...
var Je = function(r, t, i) {
  ...
  if (i)
    ...
    var a = [];
    P.forEach(t, function(f, d) {
      f === null || typeof f > "u" || (P.isArray(f) ? d = d + "[]" : f = [f], P.forEach(f, function(h) {
        P.isDate(h) ? h = h.toISOString() : P.isObject(h) && (h = JSON.stringify(h)), a.push(Re(d) + "=" + Re(h));
      }));
    }), n = a.join("&");
  }
  if (n) {
...
Object.defineProperties(_, ze);
Object.defineProperty(We, "isAxiosError", { value: !0 });
_.from = function(e, r, t, i, n, a) {
  var s = Object.create(We);
  return Ve.toFlatObject(e, s, function(f) {
    return f !== Error.prototype;
  }), _.call(s, e.message, r, t, i, n), s.name = e.name, a && Object.assign(s, a), s;
};
var D = _, Xe = {
  silentJSONParsing: !0,
  forcedJSONParsing: !0,
          ...
          if (f && !s && typeof f == "object") {
            if (w.endsWith(d, "{}"))
              ...
              h.forEach(function(u) {
                !w.isUndefined(u) && r.append(c, i(u));
              });
              return;
            }
          }
...
function xe() {
  if (Ce)
    return Y;
  Ce = 1;
  var e = v, r = Br(), t = gr(), i = Je, n = Qe, a = Ir(), s = kr(), o = Xe, f = D, d = j(), c = Mr();
  return Y = function(u) {
    return new Promise(function(nr, S) {
      var U = u.data, q = u.headers, B = u.responseType, C;
      function ve() {
      ...
      function me() {
        if (l) {
          var y = "getAllResponseHeaders" in l ? a(l.getAllResponseHeaders()) : null, x = !B || B === "text" || B === "json" ? l.responseText : l.response, O = {
            data: x,
            status: l.status,
      ...
      if ("onloadend" in l ? l.onloadend = me : l.onreadystatechange = function() {
        ...
        var x = u.timeout ? "timeout of " + u.timeout + "ms exceeded" : "timeout exceeded", O = u.transitional || o;
      ...
      "setRequestHeader" in l && e.forEach(q, function(x, O) {
        typeof U > "u" && O.toLowerCase() === "content-type" ? delete q[O] : l.setRequestHeader(O, x);
      }), e.isUndefined(u.withCredentials) || (l.withCredentials = !!u.withCredentials), B && B !== "json" && (l.responseType = u.responseType), typeof u.onDownloadProgress == "function" && l.addEventListener("progress", u.onDownloadProgress), typeof u.onUploadProgress == "function" && l.upload && l.upload.addEventListener("progress", u.onUploadProgress), (u.cancelToken || u.signal) && (C = function(y) {
...
var G, Pe;
function Hr() {
  return Pe || (Pe = 1, G = null), G;
}
var p = v, Te = Ur, _e = D, Jr = Xe, Vr = Ke, Wr = {
...
var I = {
  ...
  transformRequest: [function(r, t) {
    if (Te(t, "Accept"), Te(t, "Content-Type"), p.isFormData(r) || p.isArrayBuffer(r) || p.isBuffer(r) || p.isStream(r) || p.isFile(r) || p.isBlob(r))
      return r;
...
pe.transitional = function(r, t, i) {
  ...
  return function(a, s, o) {
    ...
    return t && !Be[s] && (Be[s] = !0, console.warn(
      n(
        s,
...
var it = {
  assertOptions: nt,
  validators: pe
}, er = v, at = Je, ge = Nr, Le = rt, k = Ge, st = Qe, rr = it, T = rr.validators;
function N(e) {
